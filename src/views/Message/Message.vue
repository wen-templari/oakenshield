...
<template>
  <div class="flex flex-col justify-start h-screen">
    ...
    <div class="h-11 flex-shrink-0 px-2 pt-2 flex items-start justify-around">
      <input
        ...
        maxlength="40"
      />
      <label class="relative mr-1 h-7 w-9 flex items-center justify-center rounded-ful cursor-pointer">
      ...
      <button class="rounded-full bg-blue-400 h-[26px] w-10 flex items-center justify-center" @click="sendPlain()">
